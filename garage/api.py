...
from registration.models import Registration, Event, RaceClass, Car, UserProfile, Coupon

v1_api = api.Api(api_name='v1')


class UserResource(ModelResource):
    cars = fields.ToManyField('registration.api.CarResource', 'cars', full=True)
    coupons = fields.ToManyField('registration.api.CouponResource', 'coupons')
...
class EventResource(ModelResource): 
    regs = fields.ToManyField('registration.api.RegistrationResource', 'regs')
