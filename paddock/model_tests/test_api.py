...
class RegistrationResourceTest(ResourceTestCase):
    ...
    def setUp(self):
        ...
        # DRY, baby. DRY.
        self.list_url =   '/paddock/api/v1/registration/'
        self.reg_detail_url = '/paddock/api/v1/registration/{0}/'.format(self.reg.pk)
        self.event_url =  '/paddock/api/v1/event/{0}/'.format(self.event.pk)
        self.rc_detail_url = '/paddock/api/v1/raceclass/{0}/'.format(self.rc.pk)
