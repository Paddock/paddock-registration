...
DATABASES = {
    'default': {
        ...
        'NAME': 'test_data.db',               # Or path to database file if using sqlite3.
...
PASSWORD_HASHERS = (
    ...
    'registration.security.PaddockPasswordHasher'
)
...
SECRET_KEY = '97@eheiu&amp;*mbyp1*k=(qcmw_2*7z^a)jct@_mve%wulwhxf0_a'
